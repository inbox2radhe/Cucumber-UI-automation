package com.FXO_Shiftleft_BDD.automation.testBase;
...
public class BaseClass {
	...
	public Page page;
	public objRepo or=new objRepo(page);
...
//	}
	...
	page.locator(or.login_lnk).click();
	page.locator(or.login_btn).click();
	page.locator(or.userID).click();
	page.locator(or.userPWD).click();
	page.locator(or.loginSubmit_btn).click();
	...
	public void clickelement(String elementName){
		...
		page.locator(elementName);
	}
	public void inputtext(String elementName, String txtValue) {
		
		page.locator(elementName).fill(txtValue);
	...
	public void selectDate_drpDown() {
		
	}
	public void selectState_drpDown() {
